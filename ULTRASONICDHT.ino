/*This is an improved version in accuracy of the ultrasonic sensor where it also combines the DHT11 sensor. The 
main theme if this program is that it is in a 3 wire mode where it uses an I/O pin as an input and an output.*/
